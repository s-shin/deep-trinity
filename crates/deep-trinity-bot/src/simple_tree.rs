...
// #[derive(Debug)]
// struct Node<'a> {
//     _parent: Option<Weak<RefCell<Node<'a>>>>,
//     children: HashMap<Action, Rc<RefCell<Node<'a>>>>,
//     game: Game<'a>,
//     reward: f32,
...
//
// impl<'a> Node<'a> {
//     fn new(game: Game<'a>, reward: f32, parent: Option<Weak<RefCell<Node<'a>>>>) -> Self {
//         Self {
//             _parent: parent,
...
// }
//
// fn expand<'a>(rc_node: Rc<RefCell<Node<'a>>>, budget: f32) -> Result<(), Box<dyn Error>> {
//     if budget <= 0.0 {
//         return Ok(());
//     }
...
//             let ok = next.hold()?;
//             let rc_child = Rc::new(RefCell::new(Node::<'a>::new(next, 0.0, Some(Rc::downgrade(&rc_node)))));
...
//     use crate::SimpleBotRunner;
//
//     #[test]
//     #[ignore]
//     fn test_simple_bot2() {
//         let seed = 0;
//         let runner = SimpleBotRunner::new(10, true, Some(seed), false);
